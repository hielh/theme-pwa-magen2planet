...
import GiftCardSummary from '@magento/venia-ui/lib/components/CartPage/PriceSummary/giftCardSummary.ee';
import GiftOptionsSummary from '@magento/venia-ui/lib/components/CartPage/PriceSummary/giftOptionsSummary.ee';
...
const PriceSummary = props => {
    ...
    const proceedToCheckoutButtonNew = !isCheckout ? (
        <div className={classes.checkoutButton_container}>
            <Button
                disabled={isPriceUpdating}
    ...
    return (
        <div className={classes.root} data-cy="PriceSummary-root">
            ...
            {proceedToCheckoutButtonNew}
            {/* <Link to={'/checkout'} className={classes.checkout}>PROCEED TO CHECKOUT</Link> */}
        </div>
    );
};
